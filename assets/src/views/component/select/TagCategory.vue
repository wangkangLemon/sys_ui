...
<template>
    <el-cascader class="tag-category-select-container" ref="container" v-loading="loading" :options='options' :show-all-levels="false" :placeholder="placeholder" @active-item-change="handleItemChange" :clearable="true" @change="setCurrVal">
    </el-cascader>
</template>

<script>
import treeUtils from '../../../utils/treeUtils'
import TagCategoryService from '../../../services/content/tagCategoryService'
export default {
    props: {
    ...
    methods: {
        ...
        handleItemChange(val) {
            ...
            TagCategoryService.getTree({ id: val[val.length - 1] })
                .then(ret => {
                    // 重新组合数据
                    ret.map((item) => {
