                        ...
                        <form class="el-form el-form--label-right">
                            <div class="el-form-item is-required"><label for="name" class="el-form-item__label" style="width: 90px;">分类名称</label>
                                <div class="el-form-item__content"
                                    ...
                                    <div class="el-input">
                                        <input autocomplete="off" type="text" rows="2" validateevent="true" class="el-input__inner"  v-if="this.selectData.name" v-model="this.selectData.name">                                      
                                        <!--<input autocomplete="off" type="text" rows="2" validateevent="true" class="el-input__inner" v-else v-model="add">-->
                                    </div>
                                </div>
                            </div>
...
<script>
    export default{
        ...
        watch: {
            'data'(){
                // if('data')
                 this.selectData = Object.assign({},this.data)  // 复制从父组件传值过来的数据
                    // if(this.add){
                    //     this.selectData.name=this.add        // 添加根节点输入的值
