    ...
    <article class="company-user-list">
        <el-card class="box-card">
            <section class="search">
                <section>
                    <label>状态</label>
                    <el-select clearable @change="fetchData" v-model="fetchParam.statusSelect">
...
<script>
    ...
    import analyticsService from '../../../services/base/analyticsService'
    function clearFn() {
        return {
            statusSelect: '',
            createTime: '',
    ...
    export default {
        ...
        methods: {
            ...
            fetchData () {
                this.loading = true
                return analyticsService.getExportList({
            ...
            downLoad (item) {
                analyticsService.exportDownload({
