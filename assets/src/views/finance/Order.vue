...
<template>
    <main id="finance-order">
        <el-button class="top-btn" type="primary">导出</el-button>
        <section class="search">
            <section>
                <i>课程</i>
                <el-input v-model="fetchParam.course_id" @keyup.enter.native="fetchData"></el-input>
            </section>
            <section>
                <i>支付方式</i>
                <el-select clearable @change="fetchData" v-model="fetchParam.pay_method" placeholder="全部">
            ...
            <DateRange title="下单时间" :start="fetchParam.time_start" :end="fetchParam.time_end" @changeStart="val=> fetchParam.time_start=val " @changeEnd="val=> fetchParam.time_end=val" :change="fetchData"></DateRange>
            <section>
                <i>订单状态</i>
                <el-select clearable @change="fetchData" v-model="fetchParam.status" placeholder="全部">
        ...
        <el-table v-loading="loading" :data="dataList" :fit="true" border>
            ...
            <el-table-column prop="pay_time_name" label="支付时间" width="180"></el-table-column>
        ...
        <el-pagination class="block" @size-change="val=> {fetchParam.pagesize=val; fetchData()}" @current-change="val=> {fetchParam.page=val; fetchData()}" :current-page="fetchParam.page" :pagesize="fetchParam.pagesize" :page-sizes="[15, 30, 60, 100]" layout="sizes,total, prev, pager, next" :total="total">
        </el-pagination>
        <!--详情-->
        <el-dialog title="订单详情" class="show-detail" v-model="showDetail">
            <div class="info" v-if="detail != null">
                ...
                <p>
                    ...
                    <span class="value">{{detail.pay_time_name}}</span>
                </p>
                <p>
...
import orderService from '../../services/course/orderService'
